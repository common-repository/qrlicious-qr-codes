<?php
class PLCHF_QRLICIOUS_QRCodes_Options_google_webfonts extends PLCHF_QRLICIOUS_QRCodes_Options{	
	...
	*/
	function __construct($field = array(), $value ='', $parent){
		...
		$fonts = get_transient('plchf_qrlicious_qrcodesopts-google-webfonts');
		if(!is_array(json_decode($fonts))){
			...
			set_transient('plchf_qrlicious_qrcodesopts-google-webfonts', $fonts, 60 * 60 * 24);

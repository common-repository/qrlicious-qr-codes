<?php
class PLCHF_QRLICIOUS_QRCodes_Options_button_set extends PLCHF_QRLICIOUS_QRCodes_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			'plchf_qrlicious_qrcodesopts-field-button_set-js', 
			PLCHF_QRLICIOUS_QRCODES_URL.'fields/button_set/field_button_set.js', 
